...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    while not isWordGuessed(secretWord, guessedLetters) and mistakesMade < 9:
        print('-------------')
        print('You have %d guesses left.'%(9 - mistakesMade))
        print('Available letters:', getAvailableLetters(guessedLetters))
        guess = input('Please guess a letter: ')
        guessInLowerCase = guess.lower()
        if guessInLowerCase in guessedLetters:
            print("Oops! You've already guessed that letter:", getGuessedWord(secretWord, guessedLetters))
        else:
            guessedLetters.append(guessInLowerCase)
